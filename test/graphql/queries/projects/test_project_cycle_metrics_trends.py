...
class TestProjectCycleMetricsTrends(WorkItemApiImportTest):

    class TestCycleMetricsTrends:
            ...
            def it_returns_the_right_number_of_measurements_2(self, setup):
                fixture = setup
            ...
            def it_returns_the_right_number_of_measurements_3(self, setup):
                fixture = setup
            ...
            def it_return_correct_results_when_there_are_no_closed_items(self, setup):
                fixture = setup
            ...
            def it_return_correct_results_when_there_is_one_closed_item(self, setup):
                fixture = setup
            ...
            def it_returns_correct_results_when_window_covers_different_numbers_of_points(self, setup):
                fixture = setup
            ...
            def it_returns_correct_results_for_multiple_points_for_a_different_window_size(self, setup):
                fixture = setup
            ...
            def it_reports_work_items_with_null_cycle_times_correctly(self, setup):
                fixture = setup
            ...
            def it_reports_effort_metrics_correctly(self, setup):
                fixture = setup
            ...
            def it_reports_duration_metrics_correctly(self, setup):
                fixture = setup
            ...
            def it_filters_epics_and_includes_subtasks_by_default(self, setup):
                fixture = setup
    ...
    class TestFilterWorkItemsByTag:
        ...
        class TestTagPassedAtProjectLevel:
            ...
            def it_returns_all_items_when_tags_is_empty(self, setup):
                fixture = setup
                project = fixture.project
                query = fixture.query
                client = Client(schema)
            ...
            def it_filters_work_items_by_multiple_tags(self, setup):
                fixture = setup
                project = fixture.project
                query = fixture.query
                client = Client(schema)
        ...
        def setup(self, setup):
            ...
            work_items = [
                ...
                dict(
                    ...
                    created_at=start_date,
                    updated_at=start_date,
                    **dict_merge(work_items_common_fields, dict(releases=['1.0.3']))
                ),
                dict(
                    key=uuid.uuid4().hex,
                    name=f'Issue 3',
