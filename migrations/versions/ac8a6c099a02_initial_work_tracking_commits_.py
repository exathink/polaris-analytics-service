"""Initial work_tracking_commits analytical model

Revision ID: ac8a6c099a02
Revises: 
Create Date: 2018-12-12 18:04:44.914447
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('commit_id', 'work_item_id'),
    schema='analytics'
    )
