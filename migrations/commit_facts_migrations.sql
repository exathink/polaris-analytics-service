...
insert into analytics.contributors (name, key, source_alias, source)
select contributor_name as name, contributor_key as key, alias as source_alias, 'vcs' as source from repos.contributor_aliases;
