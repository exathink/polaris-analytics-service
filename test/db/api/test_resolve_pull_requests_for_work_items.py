...
class TestTrelloWorkItemPullRequests:
    ...
    def it_returns_a_match_when_pull_request_display_id_matches_the_work_item_display_id(self, pull_requests_fixture):
        organization, _, repositories = pull_requests_fixture
        test_repo = repositories['alpha']
        new_key = uuid.uuid4()
        new_work_items = [
    ...
    def it_returns_a_match_when_pull_request_display_id_matches_the_work_item_url(self, pull_requests_fixture):
        organization, _, repositories = pull_requests_fixture
        test_repo = repositories['alpha']
        new_key = uuid.uuid4()
        new_work_items = [
