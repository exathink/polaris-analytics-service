...
class TestGithubCommitWorkItemResolution:
    ...
    def it_resolves_a_commit_with_a_single_work_item_id(self):
        ...
        resolved = GithubWorkItemResolver.resolve(commit_message, 'master')
    ...
    def it_resolves_a_work_item_from_branch_name(self):
        ...
        resolved = GithubWorkItemResolver.resolve(commit_message, '2378')
...
class TestPivotalCommitWorkItemResolution:
    ...
    def it_resolves_a_work_item_from_branch_name(self):
        ...
        resolved = PivotalTrackerWorkItemResolver.resolve(commit_message, '2378')
...
class TestJiraWorkItemResolution:
    ...
    def it_resolves_a_work_item_from_branch_name(self):
        ...
        resolved = JiraWorkItemResolver.resolve(commit_message, 'MONY-234')
